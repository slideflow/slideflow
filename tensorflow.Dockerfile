...
# Repair pixman
WORKDIR "/scripts"
RUN wget https://raw.githubusercontent.com/jamesdolezal/slideflow/1.4.3/pixman_repair.sh && \
    chmod +x pixman_repair.sh && \
    ./pixman_repair.sh

# Install slideflow & download scripts
RUN pip3 install slideflow[cucim]==1.4.3 cupy-cuda11x tensorflow_probability==0.17.* && \
    wget https://raw.githubusercontent.com/jamesdolezal/slideflow/1.4.3/test.py && \
    wget https://raw.githubusercontent.com/jamesdolezal/slideflow/1.4.3/run_project.py && \
    wget https://raw.githubusercontent.com/jamesdolezal/slideflow/1.4.3/qupath_roi.groovy && \
    wget https://raw.githubusercontent.com/jamesdolezal/slideflow/1.4.3/qupath_roi_legacy.groovy && \
