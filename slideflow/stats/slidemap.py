...
class SlideMap:
    ...
    Attributes
    ----------
    _meta_viz : This method was written by Kevin Sun and is based
    on the following paper: Ma, R., Sun, E., and Zou, J. (2022) A Spectral Method for 
    ...
    def _calculate_meta_viz(self, 
                            visualizations: List[np.ndarray], 
                            projection_method: Union[str, None] = None
                            ) -> Tuple[np.ndarray, np.ndarray]:
        """ Internal function to calculate the meta vizualization.
        ...
        Method for Assessing and Combining Multiple Data Visualizations.     
        """
