...
if __name__ == '__main__':
	...
	#SFP.batch_train(checkpoint="/home/shawarma/data/slideflow_projects/thyroid_5_cat/models/no_fully_connected_only_max_pool/cp.ckpt")
	...
	SFP.generate_heatmaps('NFCOMP_c')
