...
class Outcome:
	def __init__(self, outcome_headers, outcome_labels):
		self.outcome_headers = [outcome_headers] if isinstance(outcome_headers, list) else outcome_headers
...
def load_from_directory(search_directory, nested=False, starttime=None, shownames=False):
	...
	for pf in project_folders:
		...
		for model_name in models:
			...
			model_outcome = [model_outcome] if isinstance(model_outcome, list) else model_outcome
