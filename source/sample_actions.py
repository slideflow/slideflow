def main(SFP):
	...
	#SFP.extract_tiles(filter_header=['to_extract'], filter_values=['yes'], dataset_label='all')
	...
	#SFP.train(dataset_label='all',
	#	  category_header="category",
	#	  filter_header=["dataset", 'category'],
	#	  filter_values=[['train'], ['negative', 'positive']])
	#	  batch_file='batch_train.tsv')

	#SFP.evaluate(model='HPSweep0-kfold3', dataset_label='all', category_header="category", filter_header=['dataset', 'category'], filter_values=[['eval'], ['negative', 'positive']])
