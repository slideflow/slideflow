...
class Mosaic:
	...
	def generate_final_layer_from_tfrecords(self, tfrecord_array, model, image_size):
		...
		fl_weights_all, logits_all, slides_all, indices_all, tile_indices_all, tfrecord_all = [], [], [], [], [], []
		...
		for tfrecord in tfrecord_array:
			...
			fl_weights_arr, logits_arr, slides_arr, indices_arr, tile_indices_arr = [], [], [], [], []
		...
		return fl_weights_all, logits_all, slides_all, indices_all, tile_indices_all, tfrecord_all	

	def generate_from_tfrecords(self, tfrecord_array, model, image_size, focus=None):
		fl_weights, logits, slides, indices, tile_indices, tfrecords = self.generate_final_layer_from_tfrecords(tfrecord_array, model, image_size)
