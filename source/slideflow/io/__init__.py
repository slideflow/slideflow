...
class Dataset:
    '''Object to supervise organization of slides, tfrecords, and
        tiles across a one or more datasets in a stored configuration file.'''
    ...
    def get_manifest(self, key='path'):
        ...
        if key == 'path':
            ...
            filtered_tfrecords = [sfutil.path_to_name(tfr) for tfr in self.get_tfrecords()]
