...
from slideflow.gan.semantic.model import masked_feature_input
...
def create_generator_large(
	...
	c = tf.one_hot(class_input, n_classes, dtype=tf.int32)
	c = tf.squeeze(c, axis=1)
	input_layers = [noise_input, class_input, feature_tensors['image'], feature_tensors['image_vgg16']]
	...
	return tf.keras.models.Model(input_layers, out), input_layers, dummy_mask_sizes, mask_order
