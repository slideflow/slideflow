...
def create_generator(
	...
	act2 = resblock(act1, c, gf_dim * 16, n_classes)
	act3 = resblock(act2, c, gf_dim * 8, n_classes)
	act4 = resblock(act3, c, gf_dim * 4, n_classes)
	act4, _ = SelfAttnModel(gf_dim * 4)(act4)
	act5 = resblock(act4, c, gf_dim * 2 , n_classes)
	act6 = resblock(act5, c, gf_dim, n_classes)
