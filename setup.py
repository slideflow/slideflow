...
setuptools.setup(
    ...
    package_data = {
        'slideflow': [
            ...
            'studio/gui_utils/DroidSans.ttf',
            'studio/gui_utils/DroidSans-Bold.ttf',
            'studio/gui_utils/icons/error.png',
            'studio/gui_utils/icons/info.png',
            'studio/gui_utils/icons/logo.png',
            'studio/gui_utils/icons/success.png',
            'studio/gui_utils/icons/warn.png',
